          ...
          content = Column(
              controls = [
                  Row(controls = [self.result],
                      alignment = 'end'),
                  Row(controls = [ElevatedButton(text = 'AC',
                  ...
                  Row(controls = [ElevatedButton(text = '7',
                  ...
                  Row(controls = [ElevatedButton(text = '4',
                                                 bgcolor = colors.WHITE24,
                                                 color = colors.WHITE,
                                                 expand = 1,
                                                 on_click = self.button_clicked,
                  ...
                  Row(controls = [ElevatedButton(text = '1',
                                                 bgcolor = colors.WHITE24,
                                                 color = colors.WHITE,
                                                 expand = 1,
                                                 on_click = self.button_clicked,
                  ...
                  Row(controls = [ElevatedButton(text = '0',
                                                 bgcolor = colors.WHITE24,
                                                 color = colors.WHITE,
                                                 expand = 1,
                                                 on_click = self.button_clicked,
